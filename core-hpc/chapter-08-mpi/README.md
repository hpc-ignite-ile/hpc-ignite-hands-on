...
export LAB_SCRIPT="${LAB_SCRIPT:-core-hpc/chapter-08-mpi/collective_ops.py}"
...
เปลี่ยน script ได้เล็กน้อยโดยตั้ง `LAB_SCRIPT` ก่อนแปะ block เช่น `export LAB_SCRIPT=core-hpc/chapter-08-mpi/collective_ops.py`
